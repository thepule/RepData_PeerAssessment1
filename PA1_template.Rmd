...
```
The mean and median total steps per day are respectively: `r mean_withna` and `r median_withna`.
...
```
The new mean and median are respectively `r mean_withoutna` and `r median_withoutna`. Comparing
them with the original ones `r mean_withna` and `r median_withna`, the impact of filling *NA* can be clearly seen.
